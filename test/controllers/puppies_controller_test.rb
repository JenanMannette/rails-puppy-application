...
class PuppiesControllerTest < ActionController::TestCase
  ...
  test "should create puppy" do
    assert_difference('Puppy.count') do
      post :create, puppy: { age: @puppy.age, bio: @puppy.bio, breed: @puppy.breed, image_url: @puppy.image_url, integer: @puppy.integer, name: @puppy.name }
    end
  ...
  test "should update puppy" do
    patch :update, id: @puppy, puppy: { age: @puppy.age, bio: @puppy.bio, breed: @puppy.breed, image_url: @puppy.image_url, integer: @puppy.integer, name: @puppy.name }
    assert_redirected_to puppy_path(assigns(:puppy))
  end
